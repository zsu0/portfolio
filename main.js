const modals = {
      ...
      // Bug fixes: aliases & missing keys
      cert_cip: null, // resolved below
      cert_afs: { title: '✈️ AFS Exchange Certificate — Japan', content: `<p style="color:rgba(255,255,255,0.7);line-height:1.9;">1 full academic year in Japan — certified completion of AFS intercultural exchange program. Included academic study in Japanese high school and active community participation.</p>` },
      cert_coursera: { title: '💻 Python for Everybody — Coursera', content: `<p style="color:rgba(255,255,255,0.7);line-height:1.9;">Completed the University of Michigan Python for Everybody specialization on Coursera — covering data structures, web access, databases, and data visualization with Python.</p>` },
      cert_chula: { title: '🏛 Chulalongkorn University Mock Exam', content: `<p style="color:rgba(255,255,255,0.7);line-height:1.9;">Participated in Chulalongkorn University entrance mock examinations — used as an academic benchmark for university admission preparation.</p>` },
      intl: { title: '🌐 International Activities', content: `<p style="color:rgba(255,255,255,0.7);line-height:1.9;">Participated in university-organized international activities promoting cross-cultural connections and global communication skills.</p>` },
      art2: { title: '✏️ Traditional Sketching', content: `<p style="color:rgba(255,255,255,0.7);line-height:1.9;">Traditional pencil and pen sketches — figure studies, portrait work, and environment sketching in A3 sketchbooks.</p>` },
      art3: { title: '🧊 3D Modeling Works', content: `<p style="color:rgba(255,255,255,0.7);line-height:1.9;">3D interior scenes, environments, and concept art created in Blender with detailed lighting and material setups.</p>` },
      brand1: { title: '✦ Brand Identity & Logo Design', content: `<p style="color:rgba(255,255,255,0.7);line-height:1.9;">Logo design, typography systems, and full brand identity packages created for clients and personal projects.</p>` },
      ...
      '3d_char': { title: '👤 Character & Human Modeling', content: `<p style="color:rgba(255,255,255,0.7);line-height:1.9;">Stylized and semi-realistic human character models created in Blender, including rigging concepts and pose tests.</p>` },
...
// ===================== MAIN PORTFOLIO SCRIPTS =====================
    ...
    // sparkFly keyframe is defined in styles.css
